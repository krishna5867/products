...
import { addItemToCart, incrementQuantity, decrementQuantity, removeItemFromCart, fetchProducts } from './store/CartSlice'
    ...
    return (
        <div className='relative bg-gray-200'>
            ...
            {showCart && items.length > 0 && (
                <div className='absolute top-14 right-4  shadow-md z-[50] py-4 bg-white rounded-md max-h-96 overflow-scroll overflow-x-auto'>
                    {items.map((item) => (
                        <>
